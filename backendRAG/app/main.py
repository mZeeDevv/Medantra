...
from app.services.embedding_service import pil_to_base64, compute_image_embedding, compute_query_embedding
from app.services.qdrant_service import store_embedding, search_user_embeddings, ensure_collection_exists
...
# Get Gemini client - function to create client on demand
